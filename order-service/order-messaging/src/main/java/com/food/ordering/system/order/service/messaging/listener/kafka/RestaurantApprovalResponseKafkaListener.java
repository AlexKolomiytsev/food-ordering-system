    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            try {
                ...
                log.error("Caught optimistic locking exception in RestaurantApprovalResponseKafkaListener for order id: {}", restaurantApprovalResponseAvroModel.getOrderId(), e);
            } catch (OrderNotFoundException e) {
                // NO-OP for OrderNotFoundException.
                log.error("Order not found for order id: {}", restaurantApprovalResponseAvroModel.getOrderId(), e);
            }
        });
    }
}
