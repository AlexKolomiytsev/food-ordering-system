    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            ...
            kafkaProducer.send(
                    ...
                    orderKafkaMessageHelper.getKafkaCallback(orderServiceConfigData.getRestaurantApprovalResponseTopicName(), restaurantApprovalRequestAvroModel, orderId, "RestaurantApprovalRequestAvroModel"));
