...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        ...
        log.info("OrderApprovalOutboxMessage with outbox id: {} saved successfully", orderApprovalOutboxMessage.getId());
    }
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            log.error("Could not serialize OrderApprovalEventPayload for order id: {}", orderApprovalEventPayload.getOrderId(), e);
            throw new OrderDomainException("Could not serialize OrderApprovalEventPayload for order id: " + orderApprovalEventPayload.getOrderId(), e);
        }
    }
